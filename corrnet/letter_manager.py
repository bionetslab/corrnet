...
class LetterManager:
    ...
    def to_graph(self, earliest_date=None, latest_date=None, build_digraph=True, build_multi_digraph=True,
                 filter_by=None):
        ...
        if build_multi_digraph:
            ...
            multi_digraph.graph['sender_col'] = self._sender_col
            multi_digraph.graph['addressee_col'] = self._addressee_col
            multi_digraph.graph['date_col'] = self._date_col
            if len(self._attribute_cols) > 0:
                multi_digraph.graph['attribute_cols'] = self._attribute_cols
